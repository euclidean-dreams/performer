...
Ws2812bLedStrip::Ws2812bLedStrip()
        : ledDriver{},
          ...
          ledCount{Config::getInstance().getLedMatrixWidth() * Config::getInstance().getledMatrixHeight()} {
    ...
    ledDriver.channel[pwmChannel].gpionum = Config::getInstance().getGpioNumber();
